              ...
              <li key={movie.imdbID} className="overflow-hidden flex flex-col w-[17%] bg-white rounded-lg shadow-lg">
                ...
                <div className="flex flex-grow flex-row">
                  ...
                  <div className="flex flex-col p-[4%] md:p-[3%] w-[75%]">
                    ...
                    {/* Entertainment Type */}
                    <span
                      className={`flex items-center justify-center p-[1%] w-[10px] sm:w-[14px] md:w-[18px] lg:w-[22px] xl:w-[26px] text-white text-[4px] sm:text-[5px] md:text-[6px] lg:text-[8px] xl:text-[10px] font-bold rounded ${
